    ...
    <div className="p-6 bg-gray-100 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        ...
        <div className="bg-white shadow rounded-lg p-4">
          ...
          <p className="text-2xl font-bold text-gray-800 mt-2">AED 12,340</p>
        </div>
        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <ul className="space-y-3">
            <li className="flex justify-between items-center">
              <span>Product A</span>
              <span className="font-bold text-gray-800">AED 3,200</span>
            </li>
            <li className="flex justify-between items-center">
              <span>Product B</span>
              <span className="font-bold text-gray-800">AED 2,750</span>
            </li>
            <li className="flex justify-between items-center">
              <span>Product C</span>
              <span className="font-bold text-gray-800">AED 1,980</span>
            </li>
          </ul>
        </div>
      </div>
